...
async def scanner_loop():
    ...
    while True:
        try:
            ...
            # İlk tarama sonrası modeller eğitilmemişse tetikle
            if not ml_engine._trained and not rl_agent._is_trained:
                logger.info("🤖 Modeller henüz eğitilmemiş, başlangıç eğitimi başlıyor...")
                try:
