...
class MLEngine:
    ...
    def get_info(self) -> dict:
        ...
        return {
            "models": [
                {"name": "GradientBoosting", "backend": gbm_type, "weight": 0.6, "estimators": 300},
                {"name": "RandomForest", "backend": rf_type, "weight": 0.4, "estimators": 100}
            ],
            "ensemble": {"gbm":0.6,"rf":0.4},
            "n_features": FeatureBuilder.N_FEATURES,
            "features": [
                {"name": "RSI", "type": "Momentum", "importance": 0.12},
                {"name": "StochRSI", "type": "Momentum", "importance": 0.08},
                {"name": "MFI", "type": "Volume/Momentum", "importance": 0.07},
                {"name": "Williams_R", "type": "Momentum", "importance": 0.05},
                {"name": "MACD_line", "type": "Trend", "importance": 0.04},
                {"name": "MACD_sig", "type": "Trend", "importance": 0.03},
                {"name": "MACD_hist", "type": "Trend", "importance": 0.06},
                {"name": "EMA9_21", "type": "Trend", "importance": 0.09},
                {"name": "EMA50_dist", "type": "Trend", "importance": 0.04},
                {"name": "BB_pct", "type": "Volatility", "importance": 0.05},
                {"name": "BB_width", "type": "Volatility", "importance": 0.03},
                {"name": "ATR_pct", "type": "Volatility", "importance": 0.04},
                {"name": "Vol_ratio", "type": "Volume", "importance": 0.02},
                {"name": "OBV_trend", "type": "Volume", "importance": 0.02},
                {"name": "Lag1", "type": "Return", "importance": 0.01},
                {"name": "Lag2", "type": "Return", "importance": 0.01},
                {"name": "Lag3", "type": "Return", "importance": 0.01},
                {"name": "Ret5", "type": "Return", "importance": 0.02},
                {"name": "Ret10", "type": "Return", "importance": 0.03},
                {"name": "Ret20", "type": "Return", "importance": 0.04},
                {"name": "Std5", "type": "Volatility", "importance": 0.02},
                {"name": "Std20", "type": "Volatility", "importance": 0.03},
                {"name": "Pos_HL", "type": "Range", "importance": 0.02},
                {"name": "Gap_HL", "type": "Range", "importance": 0.01},
                {"name": "Mom_acc", "type": "Momentum", "importance": 0.02},
                {"name": "Body", "type": "Candle", "importance": 0.01},
                {"name": "HL_range", "type": "Candle", "importance": 0.01},
                {"name": "Upper_wick", "type": "Candle", "importance": 0.02}
            ],
            "feature_engineering_status": "Production (Stable)",
            "data_processing": "Online Min15 Stream",
